                ...
                <div class="card pd-20 pd-sm-40">
                    <div class="mycontainer">
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead>
                                <center><a href="leave_app.php"> <button class="btn btn-outline-primary"
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($con,"SELECT * FROM `leave` WHERE `status`='pending'");
...
?>
                                ...
                                <tr>
                                    ...
                                    <?php
                                            ...
                                            echo "<td><a href=\"updateStatusAccept.php?eid={$row['sid']}&descr={$row['dec']}\"><button class='btn-success btn-sm' >Accept</button></a>
                                                    <a href=\"updateStatusReject.php?eid={$row['sid']}&descr={$row['dec']}\"><button class='btn-danger btn-sm' >Reject</button></a></td>
                                                 ";
                                             ?>
