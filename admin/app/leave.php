...
<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    if($fromdate > $todate){
        ...
        $leaveApplicationValidate = false;
        echo "<Script>
        alert('from date cannot be larger than to date');
        </script>";
    }
    ...
    if($leaveApplicationValidate){
     ...
     $query = "INSERT INTO `leave`(`s_name`, `email`, `dec`, `fromdate`, `todate`, `status`, `sid`) VALUES ('$sname',' $email','$absencePlusReason', '$fromdate', '$todate', '$status','$sid')";
                ...
                <div class="card pd-20 pd-sm-40">
                    ...
                    <div class="container">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="absence[]" type="radio" value="Casual"
                                    id="Casual">
                            ...
                            <div class="mb-3 ">
                                ...
                                <input type="date" name="todate" id="todate" onchange="validateto()" required>
                            </div>
                            <script>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="leaveDesc" class="form-label"><b>Please mention reasons for your leave days
                                        :</b></label>
